            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <a onclick="loadModal(this)" target="/backend/master/role/add" class="btn btn-primary" title="Tambah Data"><i
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="table-role" >
                                        ...
                                        @foreach($data as $num => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a onclick="loadModal(this)" target="/backend/master/role/add" data="id={{$item->id}}"
    ...
    <script>
        function deleteData(id) {
            ...
            modalConfirm("Konfirmasi", "Apakah anda yakin akan menghapus data?", function () {
                ajaxTransfer("/backend/master/role/delete", data, "#modal-output");
            })
        }
