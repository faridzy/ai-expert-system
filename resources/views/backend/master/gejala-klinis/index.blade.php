            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <a onclick="loadModal(this)" target="/backend/master/gejala-klinis/add" class="btn btn-primary" title="Tambah Data"><i
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="table-role" >
                                        ...
                                        @foreach($data as $num => $item)
                                            <tr>
                                                <td>{{$num+1}}</td>
                                                <td>{{$item->nama_gejala_klinis}}</td>
                                                <td>
                                                    <a onclick="loadModal(this)" target="/backend/master/gejala-klinis/add" data="id={{$item->id}}"
    ...
    <script>
        function deleteData(id) {
            ...
            modalConfirm("Konfirmasi", "Apakah anda yakin akan menghapus data?", function () {
                ajaxTransfer("/backend/master/gejala-klinis/delete", data, "#modal-output");
            })
        }
